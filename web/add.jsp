...
<div class="container text-left" style="width: 450px;">
    ...
    <form action="/addUserServlet" method="post" class="form-horizontal">
        <input type="text" value="${pageNum}" name="pageNum" hidden>
        <input type="text" value="${pageSize}" name="pageSize" hidden>
        ...
        <div class="form-group">
            ...
            <input type="radio" name="sex" value="男" style="margin-left: 16px"/>男
